                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <a class="banner banner-1" href="getGiay.htm">
                            <img src="/WebBanQA/views/img/banner11.jpg" height="275px" alt="">
                            <div class="banner-caption text-center">
    ...
    <div class="section section-grey">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="banner banner-1">
                        <img src="/WebBanQA/views/img/banner13.jpg" alt="">
                        <div class="banner-caption text-center">
                ...
                <div class="col-md-4 col-sm-6">
                    <a class="banner banner-1" href="#">
                        <img src="/WebBanQA/views/img/banner11.jpg" alt="">
                        <div class="banner-caption text-center">
                ...
                <div class="col-md-4 col-sm-6">
                    <a class="banner banner-1" href="#">
                        <img src="/WebBanQA/views/img/banner12.jpg" alt="">
                        <div class="banner-caption text-center">
                            <h2 class="white-color">NEW COLLECTION</h2>
                        </div>
                    </a>
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-xs-6">
                    <div class="banner banner-2">
                        <img src="/WebBanQA/views/img/banner14.jpg" alt="">
